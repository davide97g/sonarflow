          ...
          <div className="container relative px-4 py-16 md:py-24 md:px-8">
            <div className="mx-auto max-w-3xl text-center space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
                <Button
                  size="lg"
                  className="text-base px-8 gap-2 bg-white text-black hover:bg-white/90"
            ...
            <Card className="border-border/50">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  ...
                  an open standard that lets AI assistants connect to external tools and data.
                  Cursor supports MCP servers: you run a small process (e.g.{" "}
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <p className="text-muted-foreground">
                    In your project, run init and fetch at least once so the MCP server has config
                    and issue data.
                  </p>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                    ...
                    <strong className="text-foreground"> npx</strong> (recommended) so Cursor runs
                    the latest Sonarflow:
                  </p>
