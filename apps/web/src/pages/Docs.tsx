    ...
    "code_smells": 15
          ...
          <TabsContent value="integration" className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Sonarflow seamlessly integrates with AI-powered editors to provide intelligent code insights.
                </p>
                      ...
                      code={`// Add to Cursor settings
{
  ...
  "sonarflow.issuesPath": ".sonar/issues.json"
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mb-3">
                      Windsurf automatically detects <code className="px-1 py-0.5 bg-muted rounded">.sonar</code> directories and provides inline suggestions.
                    </p>
                  </div>
                </div>
              </CardContent>
